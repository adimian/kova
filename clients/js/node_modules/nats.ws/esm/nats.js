...
class PullConsumerMessagesImpl extends QueuedIteratorImpl {
    ...
    constructor(c, opts, refilling = false){
        ...
        if (idle_heartbeat) {
            this.monitor = new IdleHeartbeat(idle_heartbeat, (data)=>{
    ...
    resetPending() {
        return this.consumer.info().then((_ci)=>{
            this.pending.msgs = 0;
...
class JetStreamClientImpl extends BaseApiClient {
    ...
    fetch(stream, durable, opts = {}) {
        ...
        (async ()=>{
            try {
                if (hb) {
                    monitor = new IdleHeartbeat(hb, (v)=>{
                        qi.push(()=>{
...
export { Bench as Bench, buildAuthenticator as buildAuthenticator, canonicalMIMEHeaderKey as canonicalMIMEHeaderKey, createInbox as createInbox, credsAuthenticator as credsAuthenticator, DebugEvents as DebugEvents, deferred as deferred, Empty as Empty, ErrorCode as ErrorCode, Events as Events, headers as headers, JSONCodec as JSONCodec, jwtAuthenticator as jwtAuthenticator, Match as Match, Metric as Metric, MsgHdrsImpl as MsgHdrsImpl, NatsError as NatsError, nkeyAuthenticator as nkeyAuthenticator, mod as nkeys, Nuid as Nuid, nuid as nuid, RequestStrategy as RequestStrategy, ServiceError as ServiceError, ServiceErrorCodeHeader as ServiceErrorCodeHeader, ServiceErrorHeader as ServiceErrorHeader, ServiceResponseType as ServiceResponseType, ServiceVerb as ServiceVerb, StringCodec as StringCodec, tokenAuthenticator as tokenAuthenticator, usernamePasswordAuthenticator as usernamePasswordAuthenticator };
